...
export class Home extends Component {
  ...
  handleChange = (e) => {                 // Esta onChange precisa receber uma função, esse função vai receber o proprio evento que estamos trabalhando, neste evento tem as informações do evento... como por exemplo temos o target do evento
  ...
  render() {
    ...
    // ação 1
      allPosts.filter(post => {                      // Filtrando, convertendo para minusculos, e verificando se a dentro de searchPosts, e retornando de dentro de allPosts 
        return post.title.toLowerCase()             // Converte os titulos para minusculo, 
        .includes(searchValue.toLowerCase()         //  e verifica se tem dentro de searchValue, tmb convertendo para minusculo
        );
      })
      :
      // Ação 2
